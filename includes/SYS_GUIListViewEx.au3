...
; ==========================START ZAG Change ======================================
; REMOVED THE FOLLOWING FUNCTIONS AS I DO NOT USE THEM IN LOOPER
; =================================================================================
; XXXXXX _GUIListViewEx_EditOnClick:          Edit ListView items in user-defined columns when doubleclicked
; XXXXXX _GUIListViewEx_EditItem:             Edit ListView items programatically
; XXXXXX _GUIListViewEx_EditHeader:           Edit ListView headers programatically
; XXXXXX _GUIListViewEx_ComboData:            Set data for edit combo
; END ZAG Change ================================================================
...
; REMOVED THE FOLLOWING FUNCTIONS AS I DO NOT USE THEM IN LOOPER
; =================================================================================
; XXXXXX _GUIListViewEx_EditProcess:  Runs ListView editing process
; XXXXXX _GUIListViewEx_GetLVFont:    Gets font details for ListView to be edited
; XXXXXX _GUIListViewEx_EditCoords:   Ensures item in view then locates and sizes edit control
; END ZAG Change ================================================================
...
Func _GUIListViewEx_WM_LBUTTONUP_Handler($hWnd, $iMsg, $wParam, $lParam)
	...
	If $hGLVEx_SrcHandle = $hGLVEx_TgtHandle Then
		...
		======================================================================
		== ZG 1-30-18 Looper-specific addition to the UDF                   ==
		======================================================================
		...
		== new position in the list.  It's not the  prettiest, but it does  ==
		...
		If $currentLoopMoved <> -1 Then ; if the currently playing loop is in part of the selection
			...
			highlightItem($currentPlayingEvent) ; rehighlight that item in the list
		EndIf
		...
		$aGLVEx_SrcArray = 0
		$aGLVEx_TgtArray = 0
	EndIf ; ZAG change - deleted "other listview" function (because I don't utilize it in Looper)
